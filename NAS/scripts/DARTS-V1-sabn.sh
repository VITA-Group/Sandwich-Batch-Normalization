...
# bash scripts/DARTS-V1-sabn.sh ImageNet16-120 0 777 35
echo script name: $0
echo $# arguments
if [ "$#" -lt 4 ] ;then
...
save_dir=./output/search-cell-${space}/DARTS-V1/${dataset}/${seed}/DARTS-sabn-BN${BN}-${epoch_name}
...
OMP_NUM_THREADS=4 python DARTS-V1.py \
	...
	--arch_learning_rate 0.0003 --arch_weight_decay 0.001 --model DARTS-V1-sabn \
	--workers 4 --print_freq 200 --rand_seed ${seed} --affine 1 --weight_learning_rate ${w_lr} --num_epochs ${num_epochs}
