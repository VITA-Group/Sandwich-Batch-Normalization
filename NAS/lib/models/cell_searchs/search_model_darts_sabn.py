...
from ..cell_operations_sabn import ResNetBasicblock
from .search_cells_sabn import NAS201SearchCell as SearchCell
from .genotypes import Structure
from ..model_utils import cal_entropy


class TinyNetworkDartsSaBN(nn.Module):

    def __init__(self, C, N, max_nodes, num_classes, search_space, affine, track_running_stats):
        super(TinyNetworkDartsSaBN, self).__init__()
        self._C = C
        self._layerN = N
