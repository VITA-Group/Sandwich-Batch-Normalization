...
NAS_BENCH_201_NO_SKIP = ['none', 'nor_conv_1x1', 'nor_conv_3x3', 'avg_pool_3x3']
NAS_BENCH_201_NO_SKIP_NONE = ['nor_conv_1x1', 'nor_conv_3x3', 'avg_pool_3x3']
DARTS_SPACE = ['none', 'skip_connect', 'dua_sepc_3x3', 'dua_sepc_5x5', 'dil_sepc_3x3', 'dil_sepc_5x5', 'avg_pool_3x3',
               'max_pool_3x3']

SearchSpaceNames = {'connect-nas': CONNECT_NAS_BENCHMARK,
                    'nas-bench-201': NAS_BENCH_201,
                    'nas-bench-201-no-skip': NAS_BENCH_201_NO_SKIP,
                    'nas-bench-201-no-skip-none': NAS_BENCH_201_NO_SKIP_NONE,
                    'darts': DARTS_SPACE}
