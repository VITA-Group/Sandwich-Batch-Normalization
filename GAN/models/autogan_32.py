...
class Generator(nn.Module):
    ...
    def __init__(self, args):
        ...
        self.cell1 = Cell(args, args.gf_dim, args.gf_dim, 'nearest', num_skip_in=0, short_cut=True, norm="bn", n_classes=args.n_classes)
        self.cell2 = Cell(args, args.gf_dim, args.gf_dim, 'bilinear', num_skip_in=1, short_cut=True, norm="bn", n_classes=args.n_classes)
        self.cell3 = Cell(args, args.gf_dim, args.gf_dim, 'nearest', num_skip_in=2, short_cut=False, norm="bn", n_classes=args.n_classes)
