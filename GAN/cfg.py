...
def parse_args():
    ...
    parser.add_argument(
        "--arch_g_lr", type=float, default=2e-4, help="adam: gen learning rate"
    )
    parser.add_argument(
        "--arch_d_lr", type=float, default=2e-4, help="adam: disc learning rate"
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--print_freq", type=int, default=50, help="interval between each verbose"
    )
    ...
    parser.add_argument(
        "--g_sn", type=str2bool, default=False, help="add spectral_norm on generator?"
    )
    parser.add_argument(
        "--dataset",
        type=str,
    ...
    parser.add_argument("--path_file", type=str, help="The path of data set")
    parser.add_argument(
        "--init_type",
        type=str,
        default="normal",
    ...
    parser.add_argument(
        "--stop_search_epoch", type=int, default=-1, help="The epoch of stopping search"
    )
    parser.add_argument(
        "--model",
        type=str,
    ...
    parser.add_argument(
        "--val_batch_size", type=int, default=128, help="size of the batches"
    )
    parser.add_argument("--clip", type=float, default=1.0, help="gradient clip value")
    parser.add_argument(
        "--loss", type=str, default="hinge", choices=["hinge"], help="loss type"
    )
    # parser.add_argument('--n_classes', type=int, default=0)
    parser.add_argument("--snapshot", type=int, default=0, help="snapshot or not")
